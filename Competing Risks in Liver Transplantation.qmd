...
::: incremental
- **Fine-Gray:** well-supported frequentist implementation via the `cmprsk` package [@Gray_2024]. The `survival` package [@Therneau_et_al_2000; @Therneau_2026] also provides the `finegray` function.
...
::: incremental
- It used the `cmprsk` package [@Gray_2024] and the tidy-wrapper `tidycmprsk` [@Sjoberg_et_al_2025].
